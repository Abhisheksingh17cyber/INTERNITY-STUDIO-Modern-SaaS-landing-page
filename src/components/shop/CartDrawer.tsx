                    ...
                    <div className="w-20 h-20 bg-charcoal rounded-sm overflow-hidden flex-shrink-0">
                      {item.image && item.image !== '/placeholder-watch.jpg' ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center">
                          <div className="w-10 h-10 rounded-full border border-gold/20" />
                        </div>
                      )}
                    </div>
            ...
            {items.length > 0 && (
              <div className="border-t border-silver/10 p-6 space-y-4">
                ...
                <Link
                  href="/checkout"
                  onClick={toggleCart}
                  className="block w-full h-12 bg-gold text-obsidian font-body text-sm font-semibold tracking-widest uppercase flex items-center justify-center hover:bg-gold/90 transition-colors"
                >
                  Checkout
                </Link>
