              ...
              <div className="p-8 flex flex-col justify-center">
                ...
                <div className="space-y-3">
                  ...
                  <Link
                    ...
                    onClick={() => setQuickView(null)}
                    className="w-full h-11 border border-silver/10 text-silver/50 font-body text-xs tracking-widest uppercase inline-flex items-center justify-center hover:border-gold/30 hover:text-gold transition-colors"
                  >
                    View Full Details
                  </Link>
                </div>
